...
CUSTOM_HAL_ANT = mt8188_ant_m1
CUSTOM_HAL_AUDIOFLINGER = audio
CUSTOM_HAL_CAMERA = camera
CUSTOM_HAL_CAM_CAL = BRCB032GWZ_3 GT24c32a cat24c16
CUSTOM_HAL_COMBO = mt8188
CUSTOM_HAL_EEPROM = dummy_eeprom
CUSTOM_HAL_FLASHLIGHT = dummy_flashlight
CUSTOM_HAL_IMGSENSOR = hi846_rear_mipi_raw hi846_front_mipi_raw sc800_rear_suntxd_mipi_raw sc800_front_suntxd_mipi_raw
CUSTOM_KERNEL_IMGSENSOR = hi846_rear_mipi_raw hi846_front_mipi_raw sc800_rear_suntxd_mipi_raw sc800_front_suntxd_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR =
CUSTOM_HAL_MAIN_IMGSENSOR = hi846_rear_mipi_raw sc800_rear_suntxd_mipi_raw
CUSTOM_HAL_MSENSORLIB = akl
CUSTOM_HAL_SENSORS = sensor
CUSTOM_HAL_SUB_IMGSENSOR = hi846_front_mipi_raw sc800_front_suntxd_mipi_raw
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = hi846_rear_mipi_raw sc800_rear_suntxd_mipi_raw
...
CUSTOM_KERNEL_SUB_IMGSENSOR = hi846_front_mipi_raw sc800_front_suntxd_mipi_raw
...
CUSTOM_SUNSTONE_CAMERA_METADATA_RESOLUTION = yes
DCORE_TEST_MODE1 = no
EVB = no
EVDO_IR_SUPPORT = no
...
MTK_PROJECT_DTB_NAMES = mediatek/sunstone_proto mediatek/sunstone_hvt mediatek/sunstone_evt mediatek/sunstone_dvt
...
MTK_GPU_SUPPORT = yes
MTK_GPU_VERSION = mali valhall r25p0 mt8188
...
MTK_HDR10P_VIDEO_SUPPORT = yes
MTK_HEADER_SUPPORT = no
MTK_HEAVY_LOADING_SUPPORT = no
MTK_HEIF_CAPTURE_SUPPORT = no
MTK_HEIF_CAPTURE_SUPPORT_HAL = yes
FOSMOD_MEDIA_CAMERA_HEIF_CAPTURE = yes
...
MTK_PRODUCT_LINE_PLATFORM = MT8188
...
MTK_TEE_SUPPORT = yes
MTK_TELEPHONY_ADD_ON_POLICY = no
...
MTK_TINYSYS_SCP_LOGGER_SUPPORT = no
MTK_TINYSYS_SCP_SUPPORT = no
MTK_TINYSYS_SSPM_SUPPORT = yes
MTK_TOUCHPANEL_FIRMWARE = FT8205 NT36523 ILITEK_V3
MTK_TOUCH_BOOST = no
...
MTK_WLAN_CHIP = MT7902
MTK_WLAN_PATH_SET = none
...
ST_NFC_CHIP_VERSION =
SYSTEM_AS_ROOT = yes
INTERACTION_DEFAULT_TIME_SET = 600
TRUSTKERNEL_TEE_SUPPORT = no
TRUSTONIC_TEE_SUPPORT = no
WIFI_WEP_KEY_ID_SET = no
MTK_OPTEE_SUPPORT = yes
MTK_OPTEE_UT_SUPPORT = yes
MTK_CAM_SINGLE_NR_SUPPORT = no
MTK_HDMI_RX_SUPPORT = no
MTK_DPM_SUPPORT = yes
MTK_APUSYS_RT_SUPPORT = no
MTK_APUSYS_EDMA_SUPPORT = no
MTK_TUNNEL_PLAYBACK_SUPPORT = no
MTK_BT_PROFILE_HFP_CLIENT = no
MTK_AB_OTA_UPDATER = no
MTK_POWERAQ_SUPPORT = no
MTK_CAM_SANDBOX_SUPPORT = no
MTK_CAM_AIBRIGHTNESS_SUPPORT = no
MTK_NFX_SUPPORT = no
MTK_HDMI_RXVC_SUPPORT = no
MTK_HDMI_CEC_SUPPORT = no
MTK_CAM_FISHEYE_SUPPORT = no
MTK_USB_CAM_SUPPORT = no
MTK_DPTX_SUPPORT = no
MTK_DRM_HDMI_HDCP_SUPPORT = no
MTK_DRM_HDMI_SUPPORT = no
MTK_NVRAM_SUPPORT = no
MTK_DUAL_HDMITX_SUPPORT = no
MTK_RM_PRODUCT = yes
MTK_CAMERA_OPT_IN_IDME = yes
AMZN_FSTAB = yes
MTK_FINGERPRINT = GF3626ZS2
AMZN_ENABLE_LK_AUTH = yes
AMZN_ENABLE_SSPM_AUTH = no
AMZN_ENABLE_MCUPM_AUTH = no
AMZN_ENABLE_LOGO = yes
AMZN_ENABLE_SPM_AUTH = yes
AMZN_ENABLE_APU_AUTH = yes
AMZN_ENABLE_DPM_AUTH = yes
AMZN_ENABLE_SCP_AUTH = no
AMZN_ENABLE_CCU_AUTH = no
AMZN_ENABLE_VPU_AUTH = yes
MTK_CAM_DISABLE_TUNING_BUILD_LINK = yes
FOSMOD_MEDIA_CAMERA_HEIF_CAPTURE = yes
WFD_DYNAMIC_SEC_BUF = yes
SVP_DYNAMIC_SEC_BUF = yes
